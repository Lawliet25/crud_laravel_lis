...
@section('content')
<h1>Formulario para crear nuevo editorial</h1>
<div class="container">
        <div class="row">
                ...
                <form role="form" action="{{route('editoriales.store')}}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" name="codigo_editorial" id="codigo_editorial" value="{{old('codigo_editorial')}}" placeholder="Ingresa el codigo del editorial" >
